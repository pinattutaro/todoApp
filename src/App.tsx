...
const tdtemp = [
	// {id: 1, text: "go to gym", completed: false, startdate: null, deadline: new Date(2024, 11, 4), project: 5},
	// {id: 2, text: "finish this work", completed: false, startdate: null, deadline: new Date(2024, 11, 1), project: 1},
	// {id: 3, text: "misc task", completed: false, startdate: null, deadline: new Date(2024, 11, 7), project: 10e9},
	// {id: 4, text: "clean the house", completed: false, startdate: null, deadline: new Date(2024, 12, 31), project: 2},
	// {id: 5, text: "buy groceries", completed: false, startdate: null, deadline: new Date(2024, 11, 5), project: 6},
	// {id: 6, text: "read a book", completed: false, startdate: null, deadline: new Date(2024, 11, 2), project: 3},
	// {id: 7, text: "see a doctor", completed: false, startdate: null, deadline: new Date(2024, 11, 4), project: 5},
	// {id: 8, text: "play game", completed: false, startdate: null, deadline: new Date(2024, 11, 3), project: 4},
	// {id: 9, text: "check bank account", completed: false, startdate: null, deadline: new Date(2024, 11, 6), project: 7},
	// {id: 10, text: "call my clients", completed: false, startdate: null, deadline: new Date(2024, 11, 2), project: 1},
	{id: 11, text: "prepare presentation", completed: false, startdate: null, deadline: new Date(2024, 11, 5), project: 1},
	{id: 12, text: "appointment with my bosses", completed: false, startdate: null, deadline: new Date(2024, 11, 1), project: 1},
	{id: 13, text: "apply for a job", completed: false, startdate: null, deadline: new Date(2024, 11, 8), project: 1},
	{id: 14, text: "tea with co-workers", completed: false, startdate: null, deadline: new Date(2024, 11, 3), project: 1},
								...
								return (
									<>
										{projects.filter(e => e.state).map(prj => {
											const thisTodoes = todos.filter(td => td.project === prj.id);
											...
											const setThisTodoes = (value: React.SetStateAction<Todo[]>) => {
												setTodos(prev => {
													...
													const others = prev.filter(t => t.project !== prj.id);
